...
class SavingAccount extends Account{
    ...
    addInterest(){
        this.interstAmt=this._balance*this.interst/100  
        this.deposit(this.interstAmt)
    }
    toString() {
        return "Account " + this._number + ": balance " + this._balance;
    }
}
let savingAcc=new SavingAccount(2,3)
console.log("the interest is "+savingAcc.getInterst())
